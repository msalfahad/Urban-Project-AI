"""E1.4 — record a cold visual pass's answers into its frozen register.

    python -m tools.e1_4_record_visual --stage v1 --out <dir> \
...
REGISTER = {"v1": "E1_4_VISUAL_V1_REGISTER.json",
            "v2": "E1_4_VISUAL_V2_REGISTER.json"}
